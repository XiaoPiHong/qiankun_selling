<template>
  <div v-show="data.show" class="container-component">
    <div class="container-component__collapse" @click.stop>
      <div>
        <el-input
      ...
      <div class="container-component__collapse__tree">
        ...
        >
          <vxe-column :type="data.type" tree-node>
            <template #default="{ row }">
              {{ row[data.checkboxConfig.labelField] }}
            </template>
          </vxe-column>
        </vxe-table>
      </div>
